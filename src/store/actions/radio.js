...
export const clearRadios = () => {
  return {
    type: CLEAR_RADIO_LIST
  };
};

export const playlistReorder = order => {
  return {
    type: REORDER_RADIO_LIST,
    payload: order
  };
};
...
export const create = radio => {
  ...
  function request(payload) {
    return { type: CREATE_RADIO_BEGIN, payload: payload };
  }
  function success(payload) {
    return { type: CREATE_RADIO_SUCCESS, payload: payload };
  }
  function failure(error) {
    return { type: CREATE_RADIO_FAILURE, payload: error };
  }
};
...
export const update = radio => {
  ...
  function request(payload) {
    return { type: UPDATE_RADIO_BEGIN, payload: payload };
  }
  function success(payload) {
    return { type: UPDATE_RADIO_SUCCESS, payload: payload };
  }
  function failure(error) {
    return { type: UPDATE_RADIO_FAILURE, payload: error };
  }
};
...
export const remove = id => {
  ...
  function request(payload) {
    return { type: REMOVE_RADIO_BEGIN, payload: payload };
  }
  function success(payload) {
    return { type: REMOVE_RADIO_SUCCESS, payload: payload };
  }
  function failure(error) {
    return { type: REMOVE_RADIO_FAILURE, payload: error };
  }
};
...
export const search = word => {
  ...
  function request(payload) {
    return { type: SEARCH_RADIO_BEGIN, payload: payload };
  }
  function success(payload) {
    return { type: SEARCH_RADIO_SUCCESS, payload: payload };
  }
  function failure(error) {
    return { type: SEARCH_RADIO_FAILURE, payload: error };
  }
};
...
export const getRegisteredRadios = () => {
  ...
  function request(payload) {
    return { type: GET_REGISTERED_RADIOS_BEGIN, payload: payload };
  }
  function success(payload) {
    return { type: GET_REGISTERED_RADIOS_SUCCESS, payload: payload };
  }
  function failure(error) {
    return { type: GET_REGISTERED_RADIOS_FAILURE, payload: error };
  }
};
