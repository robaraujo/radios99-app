          ...
          <View style={[styles.info, { flex: 2 }]}>
            <View level={25}>
              <Text>
                ...
                <Text style={[styles.titleHeader, { fontWeight: "500" }]}>
                  {" "}
                  99radios
                </Text>
              </Text>
          ...
          <View style={[styles.info, { flex: 2 }]}>
            <View level={25}>
              <Text style={styles.description}>
                Único aplicativo de rádios 100% gratuito, onde qualquer um pode
                cadastrar sua rádio rápidamente.
              </Text>
            </View>
          </View>
        </View>
        <View style={[styles.slide, { backgroundColor: "#fa931d" }]}>
          <View style={[styles.header]}>
            <View style={styles.imgView}>
              <Image
                style={styles.imgListenBroadcaster}
                source={require("../../assets/intro/1/listen-user.png")}
              />
            </View>
            <View style={styles.imgView} level={-30}>
              <Image
                style={styles.img11}
                source={require("../../assets/intro/1/clave.png")}
              />
            </View>
            <View style={styles.imgView} level={30}>
              <Image
                style={styles.img12}
                source={require("../../assets/intro/1/claves.png")}
              />
            </View>
            <View style={styles.imgView} level={20}>
              <Image
                style={styles.img13}
                source={require("../../assets/intro/1/bluetooth.png")}
              />
            </View>
          </View>
          <View style={styles.info}>
            ...
            <View level={25}>
              <Text style={styles.description}>
                Busque suas rádios preferidas, organize-as e crie sua própria
                playlist!
              </Text>
            </View>
          </View>
        ...
        <View style={[styles.slide, { backgroundColor: "#a4b602" }]}>
          <View style={[styles.header]}>
            <View style={styles.imgView}>
              <Image
                style={styles.imgListenBroadcaster}
                source={require("../../assets/intro/2/broadcaster.png")}
              />
            </View>
            <View style={styles.imgView} level={20}>
              <Image
                style={styles.img21}
                source={require("../../assets/intro/2/claves.png")}
              />
            </View>
            <View style={styles.imgView} level={-20}>
              <Image
                style={styles.img22}
                source={require("../../assets/intro/2/microfone.png")}
              />
            </View>
            <View style={styles.imgView} level={5}>
              <Image
                style={styles.img23}
                source={require("../../assets/intro/2/radio.png")}
              />
            </View>
          </View>
          <View style={styles.info}>
